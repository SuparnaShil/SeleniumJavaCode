...
public class DynamicDropDrown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Aurangabad (IXU)')]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//a[(@value='GOI')])[2]")).click(); //hard code
		*/
		
		//parent child dynamic drop down
